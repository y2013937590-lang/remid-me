...
public class ReviewPlanController {
    ...
    public Map<String, Object> completeReview(
        ...
        return doCompleteReview(id, request);
    }

    @PostMapping("/{id}/complete")
    public Map<String, Object> completeReviewByPost(
            @PathVariable Long id,
            @Valid @RequestBody(required = false) CompleteReviewRequest request
    ) {
        return doCompleteReview(id, request);
    ...
    private Map<String, Object> doCompleteReview(Long id, CompleteReviewRequest request) {
